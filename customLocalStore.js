...
fr: {
    ...
    proy_inbelt_title:"BOUCLIER DE RESSORT DE VÉRIFICATION THÉORIQUE",
    proy_inbelt_subtitle:"Dans ce projet, la résistance, la rigidité et la stabilité d'une pièce en tôle IRAM IAS 215-6 F36 ont été vérifiées, dont le but est d'absorber l'impact des bateaux lors de la manœuvre d'accostage. La vérification de chaque cordon de soudure a été incluse. À cette fin, des outils de mécanique computationnelle basés sur la théorie de l'élasticité linéaire résolue par la méthode des éléments finis ont été utilisés",
...
en: {
    ...
    proy_caca_subtitle:"Design and manufacturing of custom tool for manual driving of "T"´s socket punches in gas lines. the tool has a quick release system.",
